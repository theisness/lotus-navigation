    ...
    <div className={styles.wrap}>
      ...
      <div className={styles.hero}>
        <div className={styles.logoArea}>
          <img src="/app-logo.png" alt="莲花导航" className={styles.logo} />
        ...
        <div className={styles.buttons}>
          ...
          {/* App 内同样显示安卓下载入口：点了走系统下载管理器，可当手动更新通道 */}
          <a className={styles.btnAndroid} href="/api/download/latest-apk">
          ...
          <a className={styles.btnIos} href="/api/download/latest-ipa">
            <svg className={styles.btnIcon} viewBox="0 0 24 24" fill="currentColor">
